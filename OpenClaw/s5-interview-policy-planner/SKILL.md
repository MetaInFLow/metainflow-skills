...
metadata: '{"openclaw":{"skillKey":"s5-interview-policy-planner","emoji":"🧾","homepage":"https://github.com/MetaInFLow/metainflow-skills/tree/main/OpenClaw/s5-interview-policy-planner","install":[{"kind":"brew","formula":"python@3.12"},{"kind":"uv","package":"openpyxl>=3.1,<4"}]}}'
---
...
- 此目录是面向 OpenClaw 的通用版本，不包含机器本地绝对路径
- 默认仍从当前 skill 根目录执行脚本
- OpenClaw 可读取上面的 `metadata.openclaw`，用于展示 `skillKey`、图标和安装提示
- 如果运行环境尚未准备，先执行依赖安装，再进入 `prepare/finalize/full` 流程
